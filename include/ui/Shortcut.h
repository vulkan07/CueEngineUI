...
static constexpr ShortcutData SHORTCUT_DATA[] = {
    ...
    { ShortcutId::APP_SAVE_SESSION_AS, ShortcutCategory::APPLICATION, "Save session as", "trl+Shift+S" },
    ...
    { ShortcutId::APP_UNDO, ShortcutCategory::APPLICATION, "Undo", "Ctrl+Z" },
    { ShortcutId::APP_REDO, ShortcutCategory::APPLICATION, "Redo", "Ctrl+Shift+Z" },
    ...
    { ShortcutId::CUELIST_PASTE_SELECTED, ShortcutCategory::EDITING, "Cut selected cues", "Ctrl+V" },
